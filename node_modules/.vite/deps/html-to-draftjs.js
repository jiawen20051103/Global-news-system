import {
  require_Draft,
  require_immutable
} from "./chunk-7KCG56HX.js";
import "./chunk-GCPV6VEH.js";
    ...
    !(function(e, t) {
      ...
      return o = {}, i.m = a = [function(e, t) {
        ...
        function I(e2, t2, n3, r3, i2, a2) {
          ...
          if ("#text" === o2 && "\n" !== e2.textContent) return x(e2, t2, i2);
          if ("br" === o2) return { chunk: M() };
          ...
          y && ("ul" === o2 || "ol" === o2 ? (r3 = o2, n3 += 1) : ("unordered-list-item" !== y && "ordered-list-item" !== y && (r3 = "", n3 = -1), j ? (h = E(y, S(e2)), j = false) : h = w(y, n3, S(e2)))), h = h || k(), t2 = (function(e3, t3, n4) {
            var r4, i3 = O[e3];
            if (i3) r4 = n4.add(i3).toOrderedSet();
        ...
        if (i.r(n2), Object.defineProperty(n2, "default", { enumerable: true, value: t }), 2 & e && "string" != typeof t) for (var r2 in t) i.d(n2, r2, (function(e2) {
          return t[e2];
        }).bind(null, r2));
        return n2;
      }, i.n = function(e) {
